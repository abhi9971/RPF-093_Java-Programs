...
class UserRegistrationTest {
    ...
    @Test
    void firstNameTest() throws InvalidEntryException {

        String firstName = "Abhsihek";
    ...
    @Test
    void lastName() throws InvalidEntryException {
    ...
    @Test
    void contactNumber() throws InvalidEntryException {
